    ...
    return(
        <div>
          ...
          {show && (
            ...
            className={`z-10 fixed bg-mytheme bg-opacity-60 md:w-2/6 w-[80vw] h-[200px] top-[40vh] left-12 md:left-[30vw] flex flex-col justify-around rounded-lg p-4 backdrop-blur-lg`}>
